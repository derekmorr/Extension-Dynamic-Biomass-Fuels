...
namespace Landis.Extension.Fuels
{
    ...
    {
        public static Species.IDataset SpeciesDataset = null;
        ...
        protected override IInputParameters Parse()
        {
            ...
            while (! AtEndOfInput && CurrentName != DisturbanceConversionTable && CurrentName != EcoregionTable) {
                ...
                IFuelType currentFuelType = new FuelType(SpeciesDataset.Count, Model.Core.Ecoregions.Count);
            ...
            if (ReadOptionalName(EcoregionTable))
            {
                ...
                UI.WriteLine("   Loading Ecoregion data...");
                ...
                while (! AtEndOfInput && CurrentName != DisturbanceConversionTable) {
                    ...
                    bool[] ecoregions = new bool[Model.Core.Ecoregions.Count];
                    for (int i=0; i < Model.Core.Ecoregions.Count; i++)
                        ecoregions[i] = false;
            ...
            UI.WriteLine("   Reading in the Disturbance Type table...");
        ...
        {
            IEcoregion ecoregion = Model.Core.Ecoregions[ecoregionName.Actual];
            if (ecoregion == null)
